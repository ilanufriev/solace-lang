...
![Преобразование кода HW-узла (а), и SW-узла (б)](report_builder/SolaceCompilationResults.png)
...
![Процесс компиляции в языке Solace](report_builder/SolaceCompilationProcess.png)
...
![Процесс исполнения байткода Solace](report_builder/SolaceInterpretationProcess.png)
...
![Успешное выполнение тестов](report_builder/tests_success.png)
